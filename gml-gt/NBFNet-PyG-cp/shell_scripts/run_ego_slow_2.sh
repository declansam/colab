...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=$port script/samplex_ego.py -c config/transductive/wn18rr-ego-relpgexplainer-ego-nbf-Temp3-1.yaml --gpus [0,1] --use_wandb yes
