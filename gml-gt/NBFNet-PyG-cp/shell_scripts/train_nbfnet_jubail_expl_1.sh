...
cfg1="config/nbfnet/wn18rr-randomwalk-finetune-jubail.yaml"
cfg2="config/nbfnet/wn18rr-rawexplainer-finetune-jubail.yaml"
...
for k in 100 300 500 1000 5000
do
    python script/train_nbfnet.py -c "$cfg4" --gpus [0] --use_wandb no --k "$k" --num_runs 5
done