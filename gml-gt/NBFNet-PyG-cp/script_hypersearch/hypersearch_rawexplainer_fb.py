...
if __name__ == "__main__":
    ...
    cfg.explainer.ego_network = random.choice([False])
    ...
    cfg.explainer.rw_topk_node = random.choice([300, 500, 700, 1000])
    ...
    cfg.explainer.threshold = random.choice([0.3, 0.4, 0.5, 0.6, 0.7])
    # Path Params
    cfg.explainer.with_path_loss = random.choice([False])
    ...
    cfg.explainer.expl_gnn_model = False
