...
if __name__ == "__main__":
    ...
    cfg.explainer.size_reg = random.choice([0.5, 1, 1.5, 2])
    ...
    cfg.explainer.temp_end = min(random.choice([0.5, 1, 1.5, 2.0]), cfg.explainer.temp_start) # should be lower than temp start
    ...
    cfg.task.num_negative = random.choice([0])
