...
if __name__ == '__main__':
    ...
    output_file = '/storage/ryoji/Graph-Transformer/NBFNet-PyG/explanation/NBFNet/WN18RR/best-relpgexplainer-explanation-node-output/valid_output_hard_node_mask_top_k_100.pt'
