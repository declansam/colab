...
#if __has_include(<ATen/SparseTensorUtils.h>)
  #include <ATen/SparseTensorUtils.h>
#elif __has_include(<ATen/native/SparseTensorUtils.h>)
  #include <ATen/native/SparseTensorUtils.h>
#else
  #error "Neither <ATen/SparseTensorUtils.h> nor <ATen/native/SparseTensorUtils.h> found"
#endif
